...
enum {
    ...
    cmd_b_allocPtr = 66,
    cmd_supersonic_piano_wavetable = 67,
    cmd_supersonic_buffer_read = 68,      // frames from the inbox lane into a buffer
    cmd_supersonic_buffer_publish = 69,   // a buffer's frames into the outbox lane

    NUMBER_OF_COMMANDS = 70
#else

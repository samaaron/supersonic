...
```javascript
import { SuperSonic } from "https://unpkg.com/supersonic-scsynth@0.84.2/dist/supersonic.js";
...
const supersonic = new SuperSonic({
  ...
  baseURL:         CDN + "supersonic-scsynth@0.84.2/dist/",              // client, workers
  coreBaseURL:     CDN + "supersonic-scsynth-core@0.84.2/",              // engine wasm, AudioWorklet
  wasmBaseURL:     CDN + "supersonic-scsynth-core@0.84.2/wasm/",         // needed up to 0.81.0, see below
  synthdefBaseURL: CDN + "supersonic-scsynth-synthdefs@0.84.2/synthdefs/",
  sampleBaseURL:   CDN + "supersonic-scsynth-samples@0.84.2/samples/",
});

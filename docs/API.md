...
See [ClockworkClock](#clockworkclock) for the full API surface.
...
| <a id="inhtml"></a> `in:html`                                   | Pre-formatted HTML representation of an incoming OSC message with CSS classes for colorization. Only emitted when listeners are attached.                                                                             |
...
| <a id="outhtml"></a> `out:html`                                 | Pre-formatted HTML representation of an outgoing OSC message with CSS classes for colorization. Only emitted when listeners are attached.                                                                             |
...
NTP-derived "now." Accessed via [SuperSonic.clock](#clock).
...
| <a id="bufferpoolgrowthcount"></a> `bufferPoolGrowthCount`               | `number` | Number of buffer pool growth events.                                                          |
| <a id="bufferpoolmaxcapacity"></a> `bufferPoolMaxCapacity`               | `number` | Buffer pool hard ceiling in bytes.                                                            |

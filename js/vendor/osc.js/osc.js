...
/*
 * Modified for ES modules - removed UMD wrapper and Node.js dependencies
 */
...
(function () {
    ...
    osc.Long = typeof Long !== "undefined" ? Long :
        undefined;  // Browser-only: no Long support
...
/* global require, module */
    ...
    // Browser-only: no slip or EventEmitter dependencies

    // Minimal EventEmitter stub for browser-only use
...
(function () {
    ...
    osc.WebSocket = typeof WebSocket !== "undefined" ? WebSocket : undefined;  // Browser-only
...
// ES Module exports
export default osc;
export const { readPacket, writePacket, readMessage, writeMessage, readBundle, writeBundle } = osc;

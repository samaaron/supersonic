...
inline constexpr FieldInfo kFields[] = {
    ...
    { 46, "clockTempoMbpm", "milliBpm", "SuperClock tempo — the engine's internal timeline" },
...
inline constexpr NativeStatInfo kNativeStats[] = {
    ...
    { 3, "cpuAvgCenti", "centi", "Average DSP load — how much of each audio callback's time budget is used (% * 100)" },

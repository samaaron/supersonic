...
inline constexpr FieldInfo kFields[] = {
    ...
    {  1, "scsynthMessagesProcessed", "count", "Messages drained from the IN ring and dispatched" },
    ...
    {  6, "scsynthSequenceGaps", "count", "Messages lost in transit from host to SuperSonic" },
    ...
    {  9, "oscOutMessagesSent", "count", "OSC messages sent from host to SuperSonic" },
    { 10, "oscOutBytesSent", "bytes", "Total bytes sent from host to SuperSonic" },
    { 11, "oscInMessagesReceived", "count", "OSC replies received from SuperSonic" },
    { 12, "oscInBytesReceived", "bytes", "Total bytes received from SuperSonic" },
    { 13, "oscInMessagesDropped", "count", "Replies lost in transit from SuperSonic to host" },
    { 14, "oscInCorrupted", "count", "Corrupted messages detected in the ring buffer" },
    { 15, "debugMessagesReceived", "count", "Debug messages from SuperSonic" },
    ...
    { 23, "scsynthSchedulerMaxLateMs", "ms", "Maximum lateness observed in the scheduler (ms)" },
    { 24, "scsynthSchedulerLastLateMs", "ms", "Most recent late magnitude in the scheduler (ms)" },
    { 25, "scsynthSchedulerLastLateTick", "count", "Process count when the last scheduler late occurred" },
...
inline constexpr CompositeInfo kComposites[] = {
    ...
    { "debugCountBytes", "Debug messages from SuperSonic (count and bytes)" },
    { "oscSentCountBytes", "Messages | bytes sent from host to SuperSonic" },
    { "oscRecvCountBytes", "Messages | bytes received back from SuperSonic" },
    { "inRingUsedPeak", "Used / peak bytes in the IN ring buffer (host to SuperSonic)" },
    { "outRingUsedPeak", "Used / peak bytes in the OUT ring buffer (SuperSonic replies to host)" },

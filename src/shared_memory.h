...
constexpr uint32_t NATIVE_STATS_SIZE  = 36;  // u32 x9 (see field offsets below)
...
// show until it ends.
constexpr uint32_t NATIVE_STAT_NRT_MAX_PASS_US  = 24;
constexpr uint32_t NATIVE_STAT_NRT_IN_FLIGHT_US = 28;
...
constexpr uint32_t NATIVE_STAT_NRT_RECENT_WORST_US = 32;

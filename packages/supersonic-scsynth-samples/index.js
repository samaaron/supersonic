...
export const UNPKG_BASE = 'https://unpkg.com/supersonic-scsynth-samples@0.59.0/samples/';
export const JSDELIVR_BASE = 'https://cdn.jsdelivr.net/npm/supersonic-scsynth-samples@0.59.0/samples/';
